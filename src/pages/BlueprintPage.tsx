...
// Lien YouTube de la VSL — ID extrait de https://youtu.be/pxnkB2xgiuc
const YOUTUBE_VIDEO_ID = "pxnkB2xgiuc";
    ...
    <div className="page-container relative max-w-3xl mx-auto">
      ...
      >
        <div className="flex flex-wrap items-center justify-center gap-x-2 gap-y-1 mb-5">
          <span
            className="font-poppins font-extrabold text-[#FFFFFF] leading-[1.15] px-4 py-1.5 rounded-lg"
            style={{
              fontSize: "clamp(1.3rem, 4.5vw, 2.1rem)",
              background: "#FF4526",
              boxShadow: "0 8px 28px -10px rgba(255,69,38,0.6)",
            }}
          >
            Regardez cette vidéo jusqu'à la fin pour aller 5x plus vite.
          </span>
          <span className="flex items-center gap-1">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" className="vsl-arrow" style={{ animationDelay: "0s" }}>
              <path d="M12 5v14M12 19l6-6M12 19l-6-6" stroke="#FF4526" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="vsl-arrow" style={{ animationDelay: "0.25s", opacity: 0.7 }}>
              <path d="M12 5v14M12 19l6-6M12 19l-6-6" stroke="#FF4526" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </span>
        </div>
...
const objections = [
  ...
  {
    q: "Pourquoi la formation coûte seulement 9 900 FCFA ?",
    a: (
      <>
...
/* ================================================================
   FLOATING WHATSAPP — bouton flottant animé, redirige vers wa.me
   ================================================================ */
const WHATSAPP_NUMBER = "2250710612375";
const WHATSAPP_MESSAGE =
  "Bonjour Rosine 👋, je viens de voir la page de la formation Blue Print IA Academy et je suis intéressé(e). Pouvez-vous m'en dire plus ?";
  ...
  return (
    <a
      ...
      style={{
        ...
        height: "60px",
        background: "#25D366",
        boxShadow: "0 8px 30px -6px rgba(37,211,102,0.6)",
        opacity: show ? 1 : 0,
    ...
    >
      ...
      <svg
        ...
        aria-hidden="true"
      >
        <path d="M16.003 3.2c-7.06 0-12.8 5.74-12.8 12.8 0 2.26.6 4.42 1.73 6.32L3.2 28.8l6.66-1.73a12.72 12.72 0 0 0 6.14 1.57h.01c7.06 0 12.8-5.74 12.8-12.8S23.06 3.2 16.003 3.2zm0 23.04c-1.94 0-3.83-.52-5.48-1.5l-.39-.23-3.95 1.03 1.05-3.85-.26-.4a10.54 10.54 0 0 1-1.62-5.64c0-5.85 4.76-10.61 10.61-10.61 2.84 0 5.5 1.11 7.5 3.11a10.53 10.53 0 0 1 3.11 7.5c0 5.85-4.76 10.61-10.61 10.61zm5.83-7.94c-.32-.16-1.89-.93-2.18-1.04-.29-.11-.5-.16-.71.16-.21.32-.82 1.04-1 1.25-.18.21-.37.24-.69.08-.32-.16-1.35-.5-2.57-1.59-.95-.85-1.59-1.9-1.78-2.22-.18-.32-.02-.49.14-.65.14-.14.32-.37.48-.56.16-.18.21-.32.32-.53.11-.21.05-.4-.03-.56-.08-.16-.71-1.71-.97-2.34-.26-.62-.52-.54-.71-.55-.18 0-.4-.01-.61-.01-.21 0-.56.08-.85.4-.29.32-1.11 1.08-1.11 2.64 0 1.56 1.14 3.07 1.3 3.28.16.21 2.24 3.42 5.43 4.8.76.33 1.35.52 1.81.67.76.24 1.45.21 2 .13.61-.09 1.89-.77 2.16-1.52.27-.74.27-1.38.18-1.52-.08-.13-.29-.21-.61-.37z" />
      </svg>
    </a>
  );
};
